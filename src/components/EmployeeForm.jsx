...
import { createEmployee } from "../config/httpRequests";
import Input from "./Input";

const EmployeeForm = ({ close }) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="w-full h-10 flex items-center justify-between">
        <p className="text-3xl">Add new employee</p>
        <AiOutlineClose
          onClick={close}
          className="text-highlight text-2xl cursor-pointer"
        />
      </div>
      <div className="w-[900px] my-2 flex justify-center items-center gap-7">
